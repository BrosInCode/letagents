...
// The room segment is greedy (`.+`) to mirror the room routes themselves
// (e.g. history.ts matches /^\/rooms\/(.+)\/messages$/): room ids may contain
// slashes — Git rooms are `github.com/<org>/<repo>` — and a worker bearer
