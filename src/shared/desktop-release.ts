const MAC_DESKTOP_BETA_VERSION = "0.1.3";
...
export const MAC_DESKTOP_BETA_RELEASE = {
  ...
  assets: {
    arm64: macDesktopAsset(
      "arm64",
      "6010454bc7375a38571d707f90c077207a7d2b49b01a1db1655b03f4def9b502",
    ),
    x64: macDesktopAsset(
      "x64",
      "b7574e17ef87aebf418926478de10d9937fd1a96ca0c7a53b826a109302c5560",
    ),
  },
} as const;
