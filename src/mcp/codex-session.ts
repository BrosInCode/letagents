...
function buildStartPrompt(input: {
  ...
  return [
    ...
    "6. If someone appears to be checking whether workers are present, asking where a worker is, greeting the room, or calling for help, answer briefly that you are here before returning to normal work.",
    "7. If a message seems to be looking for a specific worker by name, treat that as a direct call for room presence and answer even if the name does not match your current codename exactly.",
