              ...
              text: JSON.stringify(
                {
                  ...
                  use_agent_session_id: workerRuntime.mode === "worker"
                    ? "This local worker-bearer session marker may be passed to room tools. The supplied bearer remains the only server credential."
                    : "This exact daemon-supervised agent_session_id may be passed to room tools. The credential remains daemon-private.",
                },
                null,
                2
              ),
