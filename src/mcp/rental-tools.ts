...
export async function rentalProposeEdit(
  ...
  try {
    return await deps.apiCall<RentalPatchToolResult>(
      `/api/rental/sessions/${encodeURIComponent(input.session_id.trim())}/patches/propose-edit`,
      {
        method: "POST",
        headers: { "content-type": "application/json" },
        body: JSON.stringify(body),
...
export async function rentalProposePatch(
  ...
  try {
    return await deps.apiCall<RentalPatchToolResult>(
      `/api/rental/sessions/${encodeURIComponent(input.session_id.trim())}/patches/propose-patch`,
      {
        method: "POST",
        headers: { "content-type": "application/json" },
        body: JSON.stringify(body),
...
export async function rentalRunCommand(
  ...
  try {
    return await deps.apiCall<RentalRunCommandResult>(
      `/api/rental/sessions/${encodeURIComponent(input.session_id.trim())}/commands/run`,
      {
        method: "POST",
        headers: { "content-type": "application/json" },
        body: JSON.stringify(body),
