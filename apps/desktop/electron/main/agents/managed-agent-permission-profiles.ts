...
const CURSOR_PROFILES: DesktopManagedAgentPermissionProfile[] = [
  ...
  },
  {
    id: "sandboxed_write",
    label: "Sandboxed writes",
    description: "Cursor sandbox writes remain gated behind desktop approval and sandbox tests.",
    status: "gated",
    risk: "medium",
    detail: "Do not enable until workspace writes, home/state access, keychain boundaries, shell behavior, and cancellation are tested.",
    isDefault: false,
  },
  {
    id: "full_access",
    label: "Full access",
    description: "Cursor full access is blocked until write-capable safety gates are proven.",
    status: "gated",
    risk: "high",
