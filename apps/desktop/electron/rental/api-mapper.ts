...
const PATCH_SOURCES: readonly DesktopRentalPatchSource[] = [
  "signed_change_journal",
  "explicit_patch",
  "raw_diff",
];
const PATCH_GATE_STATUSES: readonly DesktopRentalPatchGateStatus[] = [
  "pending",
  "passed",
...
const PATCH_CHECK_STATUSES: readonly DesktopRentalPatchCheckResult["status"][] = [
  "pending",
  "running",
  "passed",
  "warning",
