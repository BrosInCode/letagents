      ...
      <template v-else>
        ...
        <aside v-if="selectedTruthfulAgent" class="desktop-activity-detail" data-kind="room-agent">
          ...
          <section class="desktop-activity-inspector-list" aria-label="Room agent state">
            ...
            <article class="desktop-activity-inspector-row"><span>Room observation</span><p>{{ selectedTruthfulAgent.roomAgentState!.ingress.state }}{{ selectedTruthfulAgent.roomAgentState!.ingress.detail ? ` — ${selectedTruthfulAgent.roomAgentState!.ingress.detail}` : "" }}</p></article>
